...
RPI_PICO_W Warning
******************
Taken from Zephyr doc for rpi_pico board (confusing)  
...
It appears that GPIO0 is mapped to the RPI_PICO_W's LED.  
This has been set in the file *rpi_pico_w.overlay*.
